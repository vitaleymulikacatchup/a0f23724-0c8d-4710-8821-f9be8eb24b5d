...
export const metadata: Metadata = {
  title: "Hotel Luxuria - Luxury in the Heart of the City",
  description: "Discover Hotel Luxuria, where luxury meets comfort. Explore our rooms, dining, and services.",
  openGraph: {
    title: "Hotel Luxuria",
    description: "Discover Hotel Luxuria, where luxury meets comfort. Explore our rooms, dining, and services.",
    url: "/",
    siteName: "Hotel Luxuria",
    images: [{
  ...
  twitter: {
    ...
    title: "Hotel Luxuria",
    description: "Discover Hotel Luxuria, where luxury meets comfort.",
